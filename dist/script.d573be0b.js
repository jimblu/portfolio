...
var swup = new _swup.default({
  plugins: [new _slideTheme.default()]
});
var redBall = document.querySelector(".redBall");
var yellowBall = document.querySelector(".yellowBall");
var blueBall = document.querySelector(".blueBall"); //jaune#feed00
//rouge#ff0000
//bleubule#2e00ea
//bleuecran#6396ff
...
document.onmousemove = function (ev) {
  var positionX = ev.x;
  var positionY = ev.y;
  redBall.style.transform = "translate(".concat(-positionX / 25, "px, ").concat(-positionY / 20, "px)");
  yellowBall.style.transform = "translate(".concat(-positionX / 28, "px, ").concat(positionY / 26, "px)");
  blueBall.style.transform = "translate(".concat(positionX / 18, "px, ").concat(-positionY / 14, "px)");
};
},{"swup":"node_modules/swup/lib/index.js","@swup/slide-theme":"node_modules/@swup/slide-theme/lib/index.js"}],"../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script.js"], null)
